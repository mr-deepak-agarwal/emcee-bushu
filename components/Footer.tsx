    ...
    <footer className="relative bg-ink text-paper pt-24 pb-10 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 border-b border-paper/10 pb-16">
          <h3 className="font-display text-5xl md:text-6xl leading-[1.02] max-w-2xl">
            I bring the vibe.{" "}
          ...
          <a
            href="#book"
            className="inline-flex items-center w-fit rounded-full bg-paper text-ink px-7 py-3.5 font-mono text-xs tracking-[0.14em] uppercase hover:bg-spotlight-soft transition-colors duration-300 flex-shrink-0"
          >
            Book Bushu
          </a>
        </div>
